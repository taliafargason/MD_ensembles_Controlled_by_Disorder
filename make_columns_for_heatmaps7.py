...
def create_custom_colormap():
    colors = ["white", "red", "orange", "yellow", "green", "lightblue", "darkblue"]
    cmap = LinearSegmentedColormap.from_list("custom_cmap", colors)
    return cmap

# Overlay heatmaps
def overlay_heatmaps(matrix1, matrix2, label1, label2, output_file, cmap):
    # Create a figure
...
overlay_heatmaps(pivot_table1, reflected_pivot_table2, args.file1, args.file2, f'heatmap_{args.out}', custom_cmap)
